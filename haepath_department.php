...
<head>
    ...
    <title>Haemato Pathology || 550MCH Pathology</title>
    ...
    <link rel="icon" href="img/haemato_logo.png">
                ...
                <div class="row">
                    <div class="col-12">
                        <nav class="navbar navbar-expand-lg navbar-light bg-white">
                            <a class="navbar-brand text-uppercase text-primary d-flex justify-content-center align-items-center" href="#hae_path">
                                <img src="img/haemato_logo.png" class="site-logo" alt="">
                                ...
                                <ul class="nav-list navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu navbar-nav">
                                            ...
                                            <li class="nav-item">
                                                <a href="chempath" class="nav-link">
                                                    <i class="fa fa-angle-right"></i>
                                                    <span>Chemical Pathology</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#hae_path" class="nav-link">
                                                    <i class="fa fa-angle-right"></i>
...
<section id="hae_path" class="hae_path container-fluid vh-100">
    <div class="row">
        <div class="col-12">
            <div class="container">
                <div class="row vh-100">
                    <div class="col-12">
                        <div  class="blood_bank_home text-right">
                            <h5 class=" text-uppercase mb-3">Department</h5>
                            <h1 class="text-primary text-uppercase mb-3">
                                Haemato Pathology
                            </h1>
                            <h5 class="" style="font-size: 17px;">
                                Blood is essential for our bodies.
                            </h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row mt-5">
                    <div class="col-4 d-none d-md-block">
                        ...
                        <div class="">
                            <img src="img/services/service1.svg" class="departments_svg" alt="">
                        </div>
                    </div>
                    <div class="col-12 col-md-8">
                        <div class="">
                            <img src="img/department/hp2.png" class="w-100" alt="">
                        </div>
                        <div class=" my-4">
                            <h2 class="my-4">
                                Haemato Pathology
                            ...
                            <p>
                                Blood disorders, such as various forms of anaemia, sickle cell disease, haemophilia, the complications of blood transfusion, and malignant diseases of the blood cell, can have a huge impact on your life. Here, we take a look at haematology and the types of treatments available if you have a blood disorder.The haematology department also studies and prescribes treatment for sickle cell disease, haemophilia, the complications of blood transfusion, and malignant diseases of the blood cells.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="box mx-4 hae_path">
                                <div class="card border-0" style="width: 18rem;">
                                    ...
                                    <div class="card-body" style="background: #835873; padding: 13px !important;">
                                        ...
                                        <p class="card-text text-white-50">Haematopathologist</p>
                                    </div>
                                </div>
                    ...
                    <div class="col-6 col-lg-3">
                        <div class="d-flex align-items-center">
                            ...
                            <h5 class="font-weight-bolder text-uppercase mb-0 text-white">
                                Haemato <br> Pathology
                            </h5>
                        </div>
                        <div class="content my-3">
                            <p class="text-white-50">Haematologists are the specialists who are experts in blood and bone marrow.
                            </p>
                            <p style="position: relative;">
<!--                                <img src="img/pathology.png" style="width: 35px;margin: 10px auto" alt="">-->
                                 <ion-icon name="flower-outline" style="font-size: 30px;margin: 10px auto; color: #835873"></ion-icon>
                                <span class="content-text ml-2 text-white-50 text-capitalize">Blood is essential for <br> our bodies.</span>
                            </p>
                        </div>
                        <div class="social-icon">
                            ...
                            <a href="mailto: 550bloodbankmchmdy@gmail.com" class="btn btn-outline-primary" target="_blank">
                                <i class="fa fa-envelope"></i>
                            </a>
...
<script>
    const parallax = document.getElementById("hae_path");
